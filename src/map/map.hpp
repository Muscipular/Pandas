...
#define LOOTITEM_SIZE 15
#define MAX_MOBSKILL 80		//Max 128, see mob skill_idx type if need this higher
...
enum _sp {
	...
	SP_AP_RECOV_RATE, SP_APRATE, SP_AP_DRAIN_RATE,
	...
	SP_WEAPON_SUBSIZE, SP_ABSORB_DMG_MAXHP2, SP_NO_SIZEFIX2, // 2102-2103
	SP_SP_IGNORE_RES_RACE_RATE, SP_SP_IGNORE_MRES_RACE_RATE, // 2104-2105
	SP_MELEE_RATE, SP_AUTOSPELL_DMG_RATE, SP_AUTOSPELL_RATE, SP_SKILL_ATK_ALL, SP_SKILL_COOLDOWN_RATE, SP_ASPD_MAX, SP_AUTOSPELL_ONSKILL_ALWAYS,
	SP_SP_DMG_RATE, SP_AMMO_RATE, SP_AMMO_DMG_RATE, SP_MAGIC_CRI, SP_MAGIC_CRI_RATE, SP_EX_LEVEL, SP_MF_RATE,
